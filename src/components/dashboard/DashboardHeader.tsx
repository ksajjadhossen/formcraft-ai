...
export default function DashboardHeader() {
  return (
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-purple-900/5 dark:bg-purple-900/10 p-5 rounded-xl border border-purple-500/10">
      <div>
